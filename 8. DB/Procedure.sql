...
-- [ki. скрипты должны быть переиспользуемые, т.е. при повторном выполненнии ошибок быть не должно. Надо проверять наличие объекта в бд 
-- например в первый раз если объекта нет, создавать, а потом делать alter для хп или хф задание принимаю но балл снимаю.
